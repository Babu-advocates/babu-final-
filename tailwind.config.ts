		...
		extend: {
			colors: {
				...
				'admin-red': {
					...
					foreground: 'hsl(var(--admin-red-foreground))',
					hover: 'hsl(var(--admin-red-hover))'
				},
				'admin-blue': {
				...
				'employee-legal': {
					DEFAULT: 'hsl(var(--employee-legal))',
					foreground: 'hsl(var(--employee-legal-foreground))',
					hover: 'hsl(var(--employee-legal-hover))'
				},
				'bank-navy': {
