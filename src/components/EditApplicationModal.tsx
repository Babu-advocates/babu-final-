  ...
  useEffect(() => {
    if (application) {
      setFormData({
        ...
        office_branch: application.office_branch || "",
      });
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .update({
          ...
          office_branch: formData.office_branch,
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.office_branch} onValueChange={(value) => handleInputChange('office_branch', value)}>
                    <SelectTrigger>
