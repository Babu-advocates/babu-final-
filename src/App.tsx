...
import HomeEdits from "./pages/HomeEdits";
...
import LegalOpinionAnalytics from "./pages/LegalOpinionAnalytics";
import LitigationAnalytics from "./pages/LitigationAnalytics";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/admin/public-submissions" element={
              <AdminProtectedRoute>
                <PublicSubmissions />
              </AdminProtectedRoute>
            } />
            <Route path="/admin/home-edits" element={
              <AdminProtectedRoute>
                <HomeEdits />
              </AdminProtectedRoute>
            } />
            <Route path="/admin/legal-opinion-analytics" element={
              <AdminProtectedRoute>
                <LegalOpinionAnalytics />
              </AdminProtectedRoute>
            } />
            ...
            <Route path="/litigation/analytics" element={
              <LitigationProtectedRoute>
                <LitigationAnalytics />
              </LitigationProtectedRoute>
            } />
