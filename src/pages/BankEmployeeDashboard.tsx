        ...
        if (queries) {
          ...
          queryDetails = queries.slice(0, 10).map(query => {
            ...
            return {
              ...
              fullMessage: query.message,
              senderName: query.sender_name,
              time: timeAgo,
          ...
          // Update unread count
          setUnreadQueryCount(openQueriesCount);
        }
      }
                ...
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    {unreadQueryCount > 0 && (
                      <Badge 
                        variant="destructive" 
                        className="absolute -top-2 -right-2 h-5 w-5 p-0 text-xs flex items-center justify-center min-w-[1.25rem] animate-pulse"
                      >
                        {unreadQueryCount > 99 ? '99+' : unreadQueryCount}
                      </Badge>
                    )}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-[28rem] p-0" align="end">
                  <div className="p-4 border-b bg-card">
                    <div className="flex items-center justify-between">
                      <h3 className="font-semibold text-base text-foreground">Query Notifications</h3>
                      {unreadQueryCount > 0 && (
                        <Badge variant="secondary" className="text-xs">
                          {unreadQueryCount} unread
                        </Badge>
                      )}
                    </div>
                  </div>
                  ...
                  <ScrollArea className="h-[400px]">
                    {queryNotifications.length === 0 ? (
                      <div className="p-8 text-center text-sm text-muted-foreground">
                        ...
                        <p>No query notifications yet</p>
                      </div>
                    ) : (
                      <div className="p-2">
                        {queryNotifications.map((notification) => (
                          <Card
                            ...
                            onClick={() => {
                              ...
                              navigate('/bank-employee-queries');
                            }}
                          >
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <p className="text-sm font-medium text-foreground">
                                      Query from {notification.senderName}
                                    </p>
                                  </div>
                                  ...
                                  <div className="flex items-center justify-between text-xs text-muted-foreground">
                                    <span className="font-mono">App: {notification.applicationId}</span>
